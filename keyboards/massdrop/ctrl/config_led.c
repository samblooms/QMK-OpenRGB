...
const openrgb_config_t g_openrgb_config =
{
    ...
    // Zones types
    {OPENRGB_ZONE_TYPE_MATRIX, OPENRGB_ZONE_TYPE_LINEAR},
    ...
    },
    {
        ...
        { 16,  17,  18,  19,  20,  21,  22,  23,  64,  65,  66,  67,  68,  69,  70,  71,  78 },
        { 24,  25,  26,  27,  28,  29,  30,  31,  72,  73,  74,  75,  76,  NO_LED,  NO_LED,  NO_LED,  NO_LED },
        { 32,  33,  34,  35,  36,  37,  38,  39,  80,  81,  82,  83,  NO_LED,  NO_LED,  NO_LED,  84,  NO_LED }, 
        { 77,  40,  41,  NO_LED,  NO_LED,  42,  NO_LED,  NO_LED,  NO_LED,  43,  44,  45,  46,  NO_LED,  47,  85,  86 } 
    },
#endif
